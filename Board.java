...
public class Board {
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		// Go through each column with with the player column fixed. Check if all
		// content are same as the current player
		// if so there is a row match and this is a win
		...
		// cells[row][column]
		// Go through each row with with the player column fixed. Check if all content
		// are same as the current player
		// if so there is a column match and this is a win
		...
		// reverse digonal starts from row 1 column 3 , includes the middle cell, and
		// last row first cell
